@coollabsio Thank you for maintaining such a high-quality project!

My PR #8779 (fix for this issue) was closed by the quality gate with the `quality/rejected` label, but I'd like to understand the specific failures so I can address them properly.
...
This PR addresses the intermittent "Permission denied (publickey,password)" error by ensuring proper SSH key file permissions (600) before use.
